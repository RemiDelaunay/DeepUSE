...
from utils import get_scheduler, transfer_to_device
...
class BaseModel(ABC):
    ...
    def __init__(self, configuration):
        ...
        self.scheduler = configuration["lr_policy"]
    ...
    def update_learning_rate(self, validation_loss=None):
        ...
        print('learning rate = {0:.7f}'.format(self.lr))
