...
class RViT2Model(BaseModel):
    ...
    def forward(self):
        ...
        for t in range(channel_size-1):
            ...
            self.warped_img, self.disp_map, self.prev_state = self.net(self.input_, self.prev_state)
